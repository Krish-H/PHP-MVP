...
class CalendarController {
    ...
    public function index() {
        ...
        try {
            if (isset($params['date'])) {
                $data = $this->calendarService->getByDate($params, $roleId, $userId);
            } elseif (isset($params['start_date']) || isset($params['end_date'])) {
                $data = $this->calendarService->getByRange($params, $roleId, $userId);
            } else {
    ...
    public function tooltip($params) {
        ...
        try {
            $data = $this->calendarService->getTooltip((int) $params['id'], $roleId, $userId);
